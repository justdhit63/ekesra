...
function KelolaPJProgramTriwulanModal({ isOpen, onClose, indicator, year, onSave }) {
  ...
  const fetchTriwulanData = async () => {
    ...
    try {
      const { data, error } = await supabase
        ...
        `)
        .eq('indikator_program_id', indicator.id) // pastikan field name benar
        .eq('tahun', year);
  ...
  const handleAddPJ = async () => {
    ...
    try {
      const { data, error } = await supabase
        .from('pk_indikator_program_triwulan')
        .insert([{
          indikator_program_id: indicator.id, // pastikan field name benar
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b bg-purple-50">
          <div>
            <h2 className="text-xl font-bold text-purple-800">
              Kelola PJ Program Triwulan - {year}
            </h2>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
          ...
          <div className="bg-purple-50 p-4 rounded-lg mb-6 border border-purple-200">
            <h3 className="font-semibold mb-4 text-purple-800">Tambah Penanggung Jawab Program Baru</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
              <div className="col-span-2">
                <label className="block text-sm font-medium mb-1 text-purple-700">Penanggung Jawab</label>
                <select
                  value={newPJ.profile_id}
                  onChange={(e) => setNewPJ({...newPJ, profile_id: e.target.value})}
                  className="w-full p-2 border border-purple-200 rounded text-sm focus:ring-purple-500 focus:border-purple-500"
                >
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-purple-700">Satuan</label>
                <select
                  value={newPJ.satuan}
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-purple-700">Bobot (%)</label>
                <input
                  type="number"
                  value={newPJ.bobot}
            ...
            <div className="grid grid-cols-4 gap-3 mb-4">
              <div>
                <label className="block text-sm font-medium mb-1 text-purple-700">Target TW I</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-purple-700">Target TW II</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-purple-700">Target TW III</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-purple-700">Target TW IV</label>
                <input
                  type="number"
          ...
          <div className="border border-purple-200 rounded-lg overflow-hidden">
            <h3 className="font-semibold p-4 bg-purple-100 border-b border-purple-200 text-purple-800">
              Data Penanggung Jawab Program Triwulan
            </h3>
            ...
            {loading ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-purple-50">
                    <tr>
                      <th className="p-3 text-left text-purple-800">Penanggung Jawab</th>
                      <th className="p-3 text-center text-purple-800">TW I</th>
                      <th className="p-3 text-center text-purple-800">TW II</th>
                      <th className="p-3 text-center text-purple-800">TW III</th>
                      <th className="p-3 text-center text-purple-800">TW IV</th>
                      <th className="p-3 text-center text-purple-800">Total</th>
                      <th className="p-3 text-center text-purple-800">Capaian</th>
                      <th className="p-3 text-center text-purple-800">Aksi</th>
                    </tr>
                  </thead>
                  <tbody>
                    {triwulanData.map((item) => {
                      ...
                      return (
                        <tr key={item.id} className="border-b border-purple-100 hover:bg-purple-50">
                          <td className="p-3">
                            <div className="font-medium text-purple-800">{item.profiles?.full_name}</div>
                          ...
                          <td className="p-3 text-center">
                            <div className="space-y-1">
                              <input
                                ...
                                className="w-16 p-1 border border-purple-200 rounded text-xs text-center focus:ring-purple-500 focus:border-purple-500"
                                title="Target TW I"
                              />
                              <input
                                type="number"
                                ...
                                className="w-16 p-1 border border-purple-200 rounded text-xs text-center bg-purple-50 focus:ring-purple-500 focus:border-purple-500"
                          ...
                          <td className="p-3 text-center">
                            <div className="text-xs">
                              <div className="font-medium text-purple-800">T: {totalTarget}</div>
                              <div className="text-purple-600">R: {totalRealisasi}</div>
                            </div>
                          </td>
              ...
              <p className="p-4 text-center text-gray-500">
                Belum ada penanggung jawab untuk program ini pada tahun {year}.
              </p>
            )}
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="flex justify-end gap-3 p-6 border-t bg-purple-50">
          <button
            onClick={onClose}
...
export default KelolaPJProgramTriwulanModal;